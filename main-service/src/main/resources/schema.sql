...
CONSTRAINT event_id_in_comments FOREIGN KEY (event_id) REFERENCES events(id),
CONSTRAINT creator_id_in_comments FOREIGN KEY (creator_id) REFERENCES users(id),
CONSTRAINT unique_values_in_comments UNIQUE (creator_id, event_id, text));
